...
export const ROLLOVER_HIGH_RISK: SprintItem[] = [
  { key: 'BACK-1655', summary: '[MERCURY] API documentation and developer guide', category: 'ARTEMIS', staleDays: 9, unassigned: true },
  ...
  { key: 'BACK-1722', summary: 'Deep Pilot - Improve Recalculation Performance', category: 'CLIENT', staleDays: 14 },
  { key: 'BACK-911', summary: 'Sources incorrectly removed from consideration for subgroup matching', category: 'ARTEMIS', staleDays: 13 },
  { key: 'BACK-1659', summary: '[PARSER] Automatic document type classification', category: 'ARTEMIS', staleDays: 3, unassigned: true },
  ...
  { key: 'UI-719', summary: 'DeepRecon - Add To column to Actionable Data Pages (Accenture)', category: 'CLIENT', staleDays: 1, unassigned: true },
  { key: 'BACK-1489', summary: 'Update classification-api Base Image to Ubuntu 24.04 LTS', category: 'INFRASTRUCTURE', staleDays: 2, unassigned: true },
  ...
  { key: 'BACK-1689', summary: 'Implement data partitioning strategy', category: 'ARTEMIS', staleDays: 24, unassigned: true },
  { key: 'BACK-1691', summary: 'Kubernetes workload autoscaling configuration', category: 'ARTEMIS', staleDays: 0, unassigned: true },
  { key: 'BACK-1692', summary: 'Implement agent container health monitoring', category: 'ARTEMIS', staleDays: 24, unassigned: true }
];
