...
export const EXTRACTION_TIMESTAMP = "2026-01-30T20:52:29.807Z";
...
export const ROLLOVER_HIGH_RISK: SprintItem[] = [
  { key: 'BACK-1655', summary: '[MERCURY] API documentation and developer guide', category: 'ARTEMIS', staleDays: 0, unassigned: true },
  { key: 'BACK-1658', summary: '[PARSER] HTML structured file parsing for SEC filings', category: 'ARTEMIS', staleDays: 0, unassigned: true },
  { key: 'BACK-1661', summary: '[PARSER] Integration between Document Parser and Mercury Extraction', category: 'ARTEMIS', staleDays: 0, unassigned: true },
  { key: 'BACK-1654', summary: '[MERCURY] BBVA - Term type extraction for reconciliation', category: 'ARTEMIS', staleDays: 2, unassigned: true },
  { key: 'BACK-1659', summary: '[PARSER] Automatic document type classification', category: 'ARTEMIS', staleDays: 0, unassigned: true },
  { key: 'BACK-1663', summary: '[BLUEPRINT] Define data model and storage infrastructure', category: 'ARTEMIS', staleDays: 0, unassigned: true },
  ...
  { key: 'BACK-1689', summary: 'Implement data partitioning strategy', category: 'ARTEMIS', staleDays: 0, unassigned: true },
  { key: 'BACK-1690', summary: 'Create data lifecycle management policies', category: 'ARTEMIS', staleDays: 24, unassigned: true },
  { key: 'BACK-1691', summary: 'Kubernetes workload autoscaling configuration', category: 'ARTEMIS', staleDays: 0, unassigned: true },
  { key: 'BACK-1692', summary: 'Implement agent container health monitoring', category: 'ARTEMIS', staleDays: 0, unassigned: true },
  { key: 'BACK-1693', summary: 'GPU resource allocation for LLM inference', category: 'ARTEMIS', staleDays: 24, unassigned: true },
  { key: 'BACK-1694', summary: 'Create compute cost monitoring dashboard', category: 'ARTEMIS', staleDays: 24, unassigned: true },
  { key: 'BACK-1695', summary: 'API Gateway rate limiting implementation', category: 'ARTEMIS', staleDays: 0, unassigned: true }
];
