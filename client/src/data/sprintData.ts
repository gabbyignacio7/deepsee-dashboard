...
export const EXTRACTION_TIMESTAMP = "2026-01-28T16:05:08.061Z";
...
export const ROLLOVER_HIGH_RISK: SprintItem[] = [
  ...
  { key: 'BACK-1722', summary: 'Deep Pilot - Improve Recalculation Performance', category: 'CLIENT', staleDays: 12 },
  ...
  { key: 'BACK-1489', summary: 'Update classification-api Base Image to Ubuntu 24.04 LTS', category: 'INFRASTRUCTURE', staleDays: 0, unassigned: true },
  { key: 'BACK-1530', summary: 'Setup BBVA Mercury Extraction Schema for Trade Fail Reconciliation', category: 'ARTEMIS', staleDays: 0, unassigned: true },
  ...
  { key: 'BACK-1548', summary: 'Enable Conditional Reconciliation', category: 'ARTEMIS', staleDays: 12 },
...
export const BLOCKED_ITEMS: SprintItem[] = [
  { key: 'BACK-1796', summary: 'Automatically refresh the Allegro password before expiry', category: 'artemis', blockedDays: 6 }
];
