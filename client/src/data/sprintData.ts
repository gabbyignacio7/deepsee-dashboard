...
export const EXTRACTION_TIMESTAMP = "2026-01-29T15:39:26.768Z";
...
export const ROLLOVER_HIGH_RISK: SprintItem[] = [
  { key: 'BACK-1644', summary: 'Finish Stories for Outlook Ingestion', category: 'ARTEMIS', staleDays: 13 },
  { key: 'BACK-1655', summary: '[MERCURY] API documentation and developer guide', category: 'ARTEMIS', staleDays: 8, unassigned: true },
  { key: 'BACK-1658', summary: '[PARSER] HTML structured file parsing for SEC filings', category: 'ARTEMIS', staleDays: 13, unassigned: true },
  { key: 'BACK-1661', summary: '[PARSER] Integration between Document Parser and Mercury Extraction', category: 'ARTEMIS', staleDays: 13, unassigned: true },
  { key: 'BACK-1722', summary: 'Deep Pilot - Improve Recalculation Performance', category: 'CLIENT', staleDays: 13 },
  { key: 'BACK-911', summary: 'Sources incorrectly removed from consideration for subgroup matching', category: 'ARTEMIS', staleDays: 13 },
  ...
  { key: 'BACK-1663', summary: '[BLUEPRINT] Define data model and storage infrastructure', category: 'ARTEMIS', staleDays: 13, unassigned: true },
