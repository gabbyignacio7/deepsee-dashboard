// Engineer Capacity Data - Updated March 3, 2026 at 10:12 AM MT
// Source: JIRA Extract - Sprint 2026-S4 (Active - Day 4 of 14)
...
export const engineers: EngineerCapacity[] = [
  // Updated Mar 2, 2026 - Sprint S5 Day 4 data (JIRA API extraction)
  ...
  { name: 'Kannal Mutharasu', role: 'Software Engineer', s2Tickets: 10, s2Points: 32, s2Done: 8, s2InProgress: 2, s2Blocked: 0, completionPct: 80, s3Tickets: 4, s3Points: 16, s3Done: 8, fullWorkload: 7, s4Tickets: 6, s4Points: 9, status: 'yellow', statusNote: '2 IP, 2 CR, 2 Done, backlog debt +2', tickets: [] },
  { name: 'Kalvin Willison', role: 'Junior Software Engineer', s2Tickets: 8, s2Points: 26, s2Done: 7, s2InProgress: 0, s2Blocked: 0, completionPct: 100, s3Tickets: 7, s3Points: 20, s3Done: 17, fullWorkload: 4, s4Tickets: 4, s4Points: 5, status: 'green', statusNote: '2 IP, 1 CR, 1 Done, backlog debt 0', tickets: [] },
  { name: 'Aleksander Winski', role: 'Senior Software Engineer', s2Tickets: 6, s2Points: 16, s2Done: 3, s2InProgress: 1, s2Blocked: 0, completionPct: 50, s3Tickets: 4, s3Points: 14, s3Done: 6, fullWorkload: 12, s4Tickets: 5, s4Points: 24, status: 'red', statusNote: '2 IP, 1 CR, 2 WFA, backlog debt +4', tickets: [] },
  { name: 'Owen Riley', role: 'Staff Frontend Engineer', s2Tickets: 7, s2Points: 17, s2Done: 7, s2InProgress: 0, s2Blocked: 0, completionPct: 100, s3Tickets: 9, s3Points: 16, s3Done: 12, fullWorkload: 5, s4Tickets: 5, s4Points: 10, status: 'green', statusNote: '2 IP, 1 CR, 2 Done, backlog debt -3', tickets: [] },
...
export const capacitySummary = {
  ...
  s3Assigned: 39,
  s3Unassigned: 28,
  s3UnassignedPercent: 41.8,
  totalAssignedPoints: 103,
  unassignedPoints: 51,
  avgPointsPerEngineer: 10.3,
