// Engineer Capacity Data - Updated March 5, 2026 at 10:49 AM MT
// Source: JIRA Extract - Sprint 2026-S4 (Active - Day 6 of 14)
...
export const engineers: EngineerCapacity[] = [
  // Updated Mar 2, 2026 - Sprint S5 Day 6 data (JIRA API extraction)
  { name: 'Lane Terry', role: 'Lead Software Engineer', s2Tickets: 7, s2Points: 7, s2Done: 7, s2InProgress: 0, s2Blocked: 0, completionPct: 100, s3Tickets: 6, s3Points: 14, s3Done: 7, fullWorkload: 9, s4Tickets: 4, s4Points: 14, status: 'green', statusNote: '2 CR, 2 Done, backlog debt +2', tickets: [] },
  { name: 'Jeff Hegerhorst', role: 'Principal DevOps Engineer', s2Tickets: 4, s2Points: 13, s2Done: 3, s2InProgress: 1, s2Blocked: 0, completionPct: 75, s3Tickets: 2, s3Points: 13, s3Done: 8, fullWorkload: 6, s4Tickets: 3, s4Points: 12, status: 'yellow', statusNote: '1 IP, 1 CR, 1 Done, backlog debt +2', tickets: [] },
  ...
  { name: 'Ivan Peev', role: 'Senior Software Engineer', s2Tickets: 12, s2Points: 15, s2Done: 9, s2InProgress: 3, s2Blocked: 0, completionPct: 75, s3Tickets: 6, s3Points: 16, s3Done: 12, fullWorkload: 3, s4Tickets: 8, s4Points: 21, status: 'yellow', statusNote: '4 IP (3 stale 9d), 4 Done, backlog debt -4', tickets: [] },
  { name: 'Darius Ouderkirk', role: 'Principal Software Engineer', s2Tickets: 6, s2Points: 18, s2Done: 3, s2InProgress: 3, s2Blocked: 0, completionPct: 50, s3Tickets: 5, s3Points: 13, s3Done: 5, fullWorkload: 8, s4Tickets: 2, s4Points: 5, status: 'yellow', statusNote: '1 CR, 1 Done, backlog debt +3', tickets: [] },
  { name: 'Kannal Mutharasu', role: 'Software Engineer', s2Tickets: 10, s2Points: 32, s2Done: 8, s2InProgress: 2, s2Blocked: 0, completionPct: 80, s3Tickets: 4, s3Points: 16, s3Done: 8, fullWorkload: 7, s4Tickets: 6, s4Points: 13, status: 'green', statusNote: '1 IP, 1 ToDo, 1 CR, 3 Done, backlog debt 0', tickets: [] },
  { name: 'Kalvin Willison', role: 'Junior Software Engineer', s2Tickets: 8, s2Points: 26, s2Done: 7, s2InProgress: 0, s2Blocked: 0, completionPct: 100, s3Tickets: 7, s3Points: 20, s3Done: 17, fullWorkload: 4, s4Tickets: 4, s4Points: 8, status: 'green', statusNote: '2 Done, 1 WFA, backlog debt -2', tickets: [] },
  ...
  { name: 'Owen Riley', role: 'Staff Frontend Engineer', s2Tickets: 7, s2Points: 17, s2Done: 7, s2InProgress: 0, s2Blocked: 0, completionPct: 100, s3Tickets: 9, s3Points: 16, s3Done: 12, fullWorkload: 5, s4Tickets: 5, s4Points: 10, status: 'green', statusNote: '1 IP (stale 6d), 4 Done, backlog debt -4', tickets: [] },
...
export const engineerAllocationData = {
  lastUpdated: "March 5, 2026, 10:49 AM MT",
  engineers: engineers
};
