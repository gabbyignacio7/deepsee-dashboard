// Engineer Capacity Data - Updated March 6, 2026 at 1:36 PM MT
// Source: JIRA Extract - Sprint 2026-S4 (Active - Day 7 of 14)
...
export const engineers: EngineerCapacity[] = [
  // Updated Mar 2, 2026 - Sprint S5 Day 7 data (JIRA API extraction)
  { name: 'Lane Terry', role: 'Lead Software Engineer', s2Tickets: 7, s2Points: 7, s2Done: 7, s2InProgress: 0, s2Blocked: 0, completionPct: 100, s3Tickets: 6, s3Points: 14, s3Done: 7, fullWorkload: 9, s4Tickets: 5, s4Points: 17, status: 'green', statusNote: '1 IP, 2 CR, 2 Done, backlog debt +2', tickets: [] },
  { name: 'Jeff Hegerhorst', role: 'Principal DevOps Engineer', s2Tickets: 4, s2Points: 13, s2Done: 3, s2InProgress: 1, s2Blocked: 0, completionPct: 75, s3Tickets: 2, s3Points: 13, s3Done: 8, fullWorkload: 6, s4Tickets: 5, s4Points: 15, status: 'green', statusNote: '1 IP, 4 Done, backlog debt -1', tickets: [] },
  { name: 'Chad Hegerhorst', role: 'Lead Software Engineer in Test', s2Tickets: 5, s2Points: 18, s2Done: 4, s2InProgress: 0, s2Blocked: 0, completionPct: 80, s3Tickets: 2, s3Points: 10, s3Done: 10, fullWorkload: 4, s4Tickets: 2, s4Points: 5, status: 'yellow', statusNote: '1 IP (stale 7d), 1 Done, backlog debt +1', tickets: [] },
  { name: 'Ivan Peev', role: 'Senior Software Engineer', s2Tickets: 12, s2Points: 15, s2Done: 9, s2InProgress: 3, s2Blocked: 0, completionPct: 75, s3Tickets: 6, s3Points: 16, s3Done: 12, fullWorkload: 3, s4Tickets: 8, s4Points: 21, status: 'yellow', statusNote: '4 CR (moved from stale IP), 4 Done, backlog debt -4', tickets: [] },
  { name: 'Darius Ouderkirk', role: 'Principal Software Engineer', s2Tickets: 6, s2Points: 18, s2Done: 3, s2InProgress: 3, s2Blocked: 0, completionPct: 50, s3Tickets: 5, s3Points: 13, s3Done: 5, fullWorkload: 8, s4Tickets: 4, s4Points: 8, status: 'green', statusNote: '1 IP, 1 ToDo, 2 Done, backlog debt +2', tickets: [] },
  { name: 'Kannal Mutharasu', role: 'Software Engineer', s2Tickets: 10, s2Points: 32, s2Done: 8, s2InProgress: 2, s2Blocked: 0, completionPct: 80, s3Tickets: 4, s3Points: 16, s3Done: 8, fullWorkload: 7, s4Tickets: 6, s4Points: 14, status: 'green', statusNote: '1 IP, 1 CR, 4 Done, backlog debt -1', tickets: [] },
  ...
  { name: 'Owen Riley', role: 'Staff Frontend Engineer', s2Tickets: 7, s2Points: 17, s2Done: 7, s2InProgress: 0, s2Blocked: 0, completionPct: 100, s3Tickets: 9, s3Points: 16, s3Done: 12, fullWorkload: 5, s4Tickets: 5, s4Points: 10, status: 'green', statusNote: '1 IP (stale 7d), 4 Done, backlog debt -4', tickets: [] },
