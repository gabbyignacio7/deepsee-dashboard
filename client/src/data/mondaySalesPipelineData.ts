...
export const mondaySalesPipelineData: MondaySalesPipelineData = {
  ...
  atRiskDeals: [
    {
      ...
      arr: 59000,
      daysOverdue: 19,
      issue: "Contract EXPIRED Jan 31 (-30 days). No renewal deal tracked.",
      priority: "P0",
  ...
  // Updated from Monday.com PoV & Client Tracker - March 2, 2026
  existingCustomers: [
  ...
  existingCustomerSummary: {
    ...
    dataQualityIssue: "Colony Bank contract expired (-30 days). 55+ accounts missing ARR. 25+ missing close date."
  },
  ...
  engineeringNeeds: [
    {
      client: "Colony Bank",
      dealArr: 59000,
      need: "Contract EXPIRED -30 days. No renewal deal tracked. Immediate outreach.",
      priority: "P0",
      jiraEpic: "BACK-1965"
    },
    {
  ...
  engineeringAlignment: [
    ...
    { priority: "P0", client: "Colony Bank", arr: 59000, jiraTicket: "BACK-1965/1918/1862", status: "Contract EXPIRED -30 days. No renewal deal tracked.", stage: "Won - At Risk", daysInPipeline: 0 },
  ...
  dataQualityNotes: [
    ...
    'Colony Bank contract EXPIRED Jan 31 (-30 days) -- no renewal deal tracked',
    'BetaNxt $340K close date EXPIRED Feb 20 -- 2 days past',
    'Sprint S4 Day 9 -- 30 unassigned (45.5%), 9.2% complete',
    'ARTEMIS at 9.1% vs 60% target -- severely under-allocated',
...
export const dashboardAlerts = [
  ...
  { type: 'critical', category: 'sales', title: 'Colony Bank Contract EXPIRED (-30 days)', description: 'Renewal contract expired Jan 31. No renewal deal tracked. Immediate outreach needed.' },
