...
// Last Updated: February 27, 2026 @ 9:38 AM MT
...
// ═══════════════════════════════════════════════════════════════
// FEBRUARY 27, 2026 PIPELINE DATA
// ═══════════════════════════════════════════════════════════════

export const mondaySalesPipelineData: MondaySalesPipelineData = {
  overview: {
    asOf: "2026-02-27T09:38:00-07:00",
  ...
  atRiskDeals: [
    {
      ...
      arr: 59000,
      daysOverdue: 19,
      issue: "Contract EXPIRED Jan 31 (-27 days). No renewal deal tracked.",
      priority: "P0",
  ...
  // Updated from Monday.com PoV & Client Tracker - February 27, 2026
  existingCustomers: [
  ...
  existingCustomerSummary: {
    ...
    dataQualityIssue: "Colony Bank contract expired (-27 days). 55+ accounts missing ARR. 25+ missing close date."
  },
  ...
  engineeringNeeds: [
    {
      client: "Colony Bank",
      dealArr: 59000,
      need: "Contract EXPIRED -27 days. No renewal deal tracked. Immediate outreach.",
      priority: "P0",
      jiraEpic: "BACK-1965"
    },
    {
  ...
  engineeringAlignment: [
    ...
    { priority: "P0", client: "Colony Bank", arr: 59000, jiraTicket: "BACK-1965/1918/1862", status: "Contract EXPIRED -27 days. No renewal deal tracked.", stage: "Won - At Risk", daysInPipeline: 0 },
  ...
  dataQualityNotes: [
    ...
    'Colony Bank contract EXPIRED Jan 31 (-27 days) -- no renewal deal tracked',
    'BetaNxt $340K close date EXPIRED Feb 20 -- 2 days past',
    'Sprint S4 Day 9 -- 18 unassigned (17.5%), 58.3% complete',
...
export const dashboardAlerts = [
  ...
  { type: 'critical', category: 'sales', title: 'Colony Bank Contract EXPIRED (-27 days)', description: 'Renewal contract expired Jan 31. No renewal deal tracked. Immediate outreach needed.' },
...
export const dataLastUpdated = "February 27, 2026, 9:38 AM MT";
