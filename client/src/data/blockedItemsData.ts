// Blocked Items Data - Updated March 4, 2026 at 12:09 PM MT
...
export const sprintBlockedItems: BlockedItem[] = [
  {
    ...
    reason: "Blocked 19 days -- internal dependency"
  }
];
...
export const staleInProgressItems = [
  { key: "BACK-1299", summary: "Single Model Input CLI", assignee: "Ivan Peev", points: 0, lastUpdated: "2026-02-06", daysSinceUpdate: 26, jiraUrl: "https://deepsee.atlassian.net/browse/BACK-1299" },
  { key: "BACK-1795", summary: "Add AccountName2 to DTCC Output", assignee: "Aleksander Winski", points: 2, lastUpdated: "2026-02-13", daysSinceUpdate: 19, jiraUrl: "https://deepsee.atlassian.net/browse/BACK-1795" },
  { key: "BACK-1911", summary: "Complete artemis-platform Project Setup", assignee: "Lane Terry", points: 5, lastUpdated: "2026-02-13", daysSinceUpdate: 19, jiraUrl: "https://deepsee.atlassian.net/browse/BACK-1911" },
  { key: "BACK-1297", summary: "Single Model Workflow", assignee: "Ivan Peev", points: 8, lastUpdated: "2026-02-13", daysSinceUpdate: 19, jiraUrl: "https://deepsee.atlassian.net/browse/BACK-1297" },
  { key: "BACK-1810", summary: "Pentest - SSL Cipher for WPEngine", assignee: "Brandon Baguley", points: 2, lastUpdated: "2026-02-13", daysSinceUpdate: 19, jiraUrl: "https://deepsee.atlassian.net/browse/BACK-1810" },
  { key: "CI-935", summary: "CNPG Backup cleanup", assignee: "Jeff Hegerhorst", points: 3, lastUpdated: "2026-02-13", daysSinceUpdate: 19, jiraUrl: "https://deepsee.atlassian.net/browse/CI-935" },
  { key: "BACK-1862", summary: "Colony Bank RV loans evaluation", assignee: "Konnor Willison", points: 8, lastUpdated: "2026-02-13", daysSinceUpdate: 19, jiraUrl: "https://deepsee.atlassian.net/browse/BACK-1862" }
];

// Stale Code Review items (>3 days)
export const staleCodeReviewItems = [
  { key: "BACK-1918", summary: "[Colony] GAP Coverage Provider", assignee: "Kannal Mutharasu", points: 5, daysInReview: 19, jiraUrl: "https://deepsee.atlassian.net/browse/BACK-1918" },
  { key: "BACK-1792", summary: "JAVA Unit Test Markdowns", assignee: "Brandon Baguley", points: 1, daysInReview: 19, jiraUrl: "https://deepsee.atlassian.net/browse/BACK-1792" }
];
