...
// Generated: February 18, 2026 at 5:00 PM MT
...
export const allPRDs: PRD[] = [
  ...
  // ========== AI/AGENT PRDs ==========
  {
    ...
    confluenceUrl: "https://deepsee.atlassian.net/wiki/spaces/PROD/pages/2816147457",
...
export const allPRDTickets: PRDTicket[] = [
  ...
  // ========================================
  {
    ...
    prdUrl: "https://deepsee.atlassian.net/wiki/spaces/PROD/pages/2816147457",
...
export const dashboardMeta = {
  ...
  dataSources: {
    jira: {
      lastSync: "February 18, 2026, 5:00 PM MT",
      sprint: "2026-S3",
      totalTickets: 109
    },
    confluence: {
...
// Data Timestamp
export const prdDataLastUpdated = "February 18, 2026 5:00 PM MT";
