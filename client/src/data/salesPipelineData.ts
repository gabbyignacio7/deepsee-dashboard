...
// Monday.com CRM Data - Updated February 13, 2026
...
export const salesPipelineData: SalesPipelineData = {
  ...
  dataQuality: {
    ...
    notes: "Complete data from Monday.com CRM. All 98 active opportunities have full data. Last sync: February 13, 2026."
  }
};
