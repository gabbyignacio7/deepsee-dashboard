...
// Monday.com CRM Data - Updated January 5, 2026
...
export const dataLastUpdated = "January 5, 2026 1:30 AM MT";
...
export const salesPipelineData: SalesPipelineData = {
  lastUpdated: "January 5, 2026 1:30 AM MT",
  ...
  dataQuality: {
    ...
    notes: "Complete data from Monday.com CRM. All 22 active opportunities have full data. Last sync: January 5, 2026."
  }
};
