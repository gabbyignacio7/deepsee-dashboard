...
// Monday.com CRM Data - Updated February 27, 2026
...
export const salesPipelineData: SalesPipelineData = {
  ...
  dataQuality: {
    ...
    notes: "Complete data from Monday.com CRM. All 107 active opportunities have full data. Last sync: February 27, 2026."
  }
};
